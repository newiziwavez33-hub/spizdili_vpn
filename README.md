...
<h1 align="center">🦝 SPIZDILI_VPN (v1.0.6.1)</h1>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-v1.0.6.1-blue?style=flat-square" alt="Version" />
...
2. Скачайте **`SPIZDILI_VPN.exe`** (или `SPIZDILI_VPN_v1.0.6.1_Windows_x64.zip`).
...
# Создает dist/SPIZDILI_VPN.exe и dist/SPIZDILI_VPN_v1.0.6.1_Windows_x64.zip
```
