...
<h1 align="center">🦝 SPIZDILI_VPN (v1.0.6)</h1>
...
2. Скачайте **`SPIZDILI_VPN.exe`** (или `SPIZDILI_VPN_v1.0.6_Windows_x64.zip`).
...
# Создает dist/SPIZDILI_VPN.exe и dist/SPIZDILI_VPN_v1.0.6_Windows_x64.zip
```
